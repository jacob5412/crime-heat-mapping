...
crawler_output = pd.read_csv("./classifier/data/crawler-output.csv", sep="|")
predictions = pd.read_csv("./classifier/predicted_results/predictions_all.csv", sep="|")
predictions.rename(columns={"NEW_PREDICTED": "category"}, inplace=True)
